...
var Model = (function() {
  ...
  Model.query = function(params,options){
    if(this.ajax) return this.ajax.call(this, 'query', options );
  }
  ...
  Model.prototype.create = function(options) {
    ...
    if(parentModel.ajax) return parentModel.ajax.call(clone, 'create', this.constructor, options );
    return clone;
  };
  ...
  Model.prototype.update = function(options) {
    ...
    if(parentModel.ajax) return parentModel.ajax.call(clone, 'update', this.constructor, options );
    return clone;
  };
  ...
  Model.prototype.destroy = function(options) {
    ...
    this.unbind();
    if(parentModel.ajax) return parentModel.ajax.call(clone, 'destroy', this.constructor, options );
    return this;
  };
...
Model.new = function(name, attributes) {
  var Instance;
  if (attributes == null) {
    attributes = [];
  }
