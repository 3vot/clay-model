...
var Model = (function() {
  ...
  Model.push = function(options){
    var _this = this;
    if(this.ajax) return this.ajax.call(this, 'push', options )

    throw "Ajax Module not defined"
  }

  Model.pull = function(options){
    var _this = this;
    if(this.ajax) return this.ajax.call(this, 'pull', options )

    throw "Ajax Module not defined"
  }

  Model.realtime = function(options){
    var _this = this;
    if(this.ajax) return this.ajax.call(this, 'realtime', options )
 ...
 Model.prototype.update = function(options) {
    ...
    if(parentModel.ajax  && !options.ignoreAjax) return parentModel.ajax.call(clone, 'update', this.constructor, options )
      ...
      .then( function(){ return parentModel.trigger("db_update"); } )
  ...
  Model.prototype.destroy = function(options) {
    ...
    if(parentModel.ajax  && !options.ignoreAjax) return parentModel.ajax.call(this, 'destroy', this.constructor, options )
      .then(function(){ parentModel.trigger("db_destroy"); return _this; });
    return this;
  };
